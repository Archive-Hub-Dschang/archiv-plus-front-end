...
export default function LoginPage() {
    ...
    return (
        <div
            className="flex w-full max-sm:py-8 flex-col justify-center space-y-6 sm:w-[350px] md:h-[480px] xl:h-[550px] max-md:px-4">
                ...
                <div className="grid gap-2">
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/forgot-password"
                              className="text-sm font-medium text-primary underline-offset-4 hover:underline hover:text-blue-600">Mot
            ...
            <div className="grid gap-2">
                <p className="text-center text-sm text-muted-foreground">
                    ...
                    <Link href="/register" className="font-medium text-blue-600 underline-offset-4 hover:underline">Créer
                        un compte</Link>
                </p>
            </div>
        </div>
